...
const Register = () => {
    ...
    return (
        <div className="flex min-h-full max-w-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div className='flex items-center mb-3 gap-3 justify-center'>
                    <p className="mt-6 text-center text-sm text-gray-500">
                        ...
                        <a href="/login" className="font-semibold leading-6 text-black hover:text-slate-600">
                            Sign in
                        </a>
                    </p>
                </div>
